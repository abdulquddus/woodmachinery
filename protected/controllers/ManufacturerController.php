  ...
  parent::__construct($id,$module=null);
	 ...
	 */
        ...
        //print_r($_REQUEST); exit;
            ...
            $this->redirect(array('manufacturer/admin'));
...
$rnd=rand();
  ...
  $uploadedFile=CUploadedFile::getInstance($model,'image_logo');

            $fileName = "{$rnd}-{$uploadedFile}";  // random number + file name

            $model->image_logo = $fileName;
...

{
    ...
    $uploadedFile->saveAs("logos/$fileName");
...

{
    ...
    $_POST['Manufacturer']['image_logo'] = $model->image_logo;
...

{
       ...
       if(!empty($uploadedFile))  // check if uploaded file is set or not

                {
                    ...
                    $uploadedFile->saveAs(Yii::app()->basePath.'/../logos/'.$model->image_logo);
