    ...
    $start=1;
					...
					<div class="headline col-md-12">
                                            <div class="pull-left col-md-10">
                                                <a  href="<?php echo Yii::app()->baseUrl ?>/index.php/web/dblog/id/<?php echo $data['id'] ?>">
                                                    <h5><strong><?php echo $data->date=date("d-m-Y",  strtotime($data->date)).'-'.$data['title']?> </a>
                                                </strong></h5>
                                                    <p><?php echo substr($data['content'],0,150)?>.</p></div>
