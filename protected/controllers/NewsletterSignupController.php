...
public function actionChangestatus()
        ...
        //print_r($_REQUEST); exit;
            ...
            $this->redirect(array('newsletterSignup/admin'));
...
if(isset($_POST['NewsletterSignup']))

{

$model->attributes=$_POST['NewsletterSignup'];
...
$model=new NewsletterSignup('search');

$model->unsetAttributes();  // clear any default values

if(isset($_GET['NewsletterSignup']))

$model->attributes=$_GET['NewsletterSignup'];
...
$model=NewsletterSignup::model()->findByPk($id);
