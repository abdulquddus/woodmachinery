                ...
                <article class="tab_content slider-thumb sld" id="tab17" style="height:420px;">
                  <div id="slider" class="flexslider">
                    <ul class="slides">
                        ...
                        <?php $images= EqImages::model()->findAllByAttributes(array('id_equipment'=>$eqid)); 
						foreach ($images as $image) {
                        ?>
					  <li><a href="<?php echo Yii::app()->baseUrl ?>/upload/images/<?php echo $image['image_large'] ?>" class="group4" title="Title"> <img src="../../upload/images/small_<?php echo $image['image_large'] ?>"/></a></li>
 <?php } ?>
					</ul>
                  </div>
...
<!--          <div class="priceheading">
          ...
          <div class="priceheading">Price: $<?php echo $data->price ;  if($data->price_start < date('Y-m-d-') &&  $data->price_end > date('Y-m-d-')) {  ?> <span>Our Price: $<?php echo $data->our_price ;  ?></span><?php } ?></div>
	...
	function popup(){
		window.open('tellafriend', 'tellafriend_script','scrollbars=1,statusbar=1,resizable=1,width=400,height=510');
          ...
          <div class="btnwrapper">
            ...
            <div class="btnright">
            <div class="btn3"><a href="javascript:void(printDiv('second'));">Print Page</a></div>
            </div>
          </div>
        </div>
      </div>
