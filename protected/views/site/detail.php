...
<p style="padding: 10px;"><?php echo  $data['details'] ?></p>
			                ...
			                <div class="myTable4">
			                    <table class="table table-striped table-condensed">
			                      ...
			                      <tr class="tableFont2">
			                        ...
			                        <td><center><div class="badge badge-success" style="width:65px;"><?php $staus=array(0=>'Close',1=>'Open',2=>'Resolved'); echo  $staus[$data['status']] ?></div></center></td>
			                        <td>High</td>
			                      </tr>
			                    </tbody></table>
			                </div>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none" ><!--Modal Starts-->
